import { BallRadius, HEIGHT, WIDTH, obstacleRadius, sinkWidth } from "../../utils/Common_Constant";
import { pad, unpad } from "../../utils/Value_padding";
import { Obstacles, Sink, createSinks, createObstacles } from "../../utils/components";
import { Ball } from "./Ball"

export class BallManager {
  private balls: Ball[];
  private convasRef: HTMLCanvasElement;
  ...
  constructor(convasRef: HTMLCanvasElement, onFinish?: (index: number, startX?: number) => void) {
    this.balls = [];
    this.convasRef = convasRef;
    this.ctx = this.convasRef.getContext("2d")!;
